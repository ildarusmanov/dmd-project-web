...
use app\modules\admin\controllers\ApplicationController;
...
class MessagesController extends ApplicationController
{
    ...
    public function actionView($id)
    {
        ...
        $model = MessagesManager::read($model, 0);
    ...
    public function actionCreate()
    {
        ...
        {
            $model = MessagesManager::create($request->post(), 0);
        }
        ...
        if (!$model->isNewRecord)
        {
            ...
            return $this->render('create', [
                'model' => $model,
                'receivers' => \app\components\helpers\MessagesHelper::receivers_list(0),
            ]);
        }
    }
    ...
    {
        $model = $this->findModel($id);
        $model = MessagesManager::delete($model, 0);
